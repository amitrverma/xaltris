...
<table className="w-full text-left border-collapse my-6">
  <thead>
    <tr>
      <th className="border-b border-gray-200 dark:border-gray-800 py-2 pr-4 text-sm font-semibold text-gray-700 dark:text-gray-200">
        Old Reflex
      </th>
      <th className="border-b border-gray-200 dark:border-gray-800 py-2 text-sm font-semibold text-gray-700 dark:text-gray-200">
        New Reflex
      </th>
    </tr>
  </thead>
  <tbody className="align-top text-[15px] leading-6 text-gray-800 dark:text-gray-100">
    <tr>
